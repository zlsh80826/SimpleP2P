...
void protobuf_AssignDesc_regist_2eproto() {
  ...
  static const int Regist_offsets_[2] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Regist, id_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Regist, passwd_),
  };
  Regist_reflection_ =
...
#ifndef _MSC_VER
const int Regist::kIdFieldNumber;
const int Regist::kPasswdFieldNumber;
#endif  // !_MSC_VER
