...
#ifndef PROTOBUF_check_2eproto__INCLUDED
#define PROTOBUF_check_2eproto__INCLUDED
...
class Check : public ::google::protobuf::Message {
 public:
  Check();
  virtual ~Check();
...
#endif  // PROTOBUF_check_2eproto__INCLUDED
